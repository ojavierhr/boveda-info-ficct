--
titulo: Proyecto proy - 01_infotech
materia: sistemas-operativos
tipo: proyecto
estado: planificando
fecha-inicio: 2026-03-17
fecha-entrega: 2026-05-05
integrantes: carlos, carla, nando
tags: [proyecto, sistemas-operativos]
---
# Proyecto proy: 01_infotech
...
_¿Que hay que hacer?_

---

## 🎯 Objetivos
<!-- Listar los objetivos especificos a cumplir -->
- [ ] 
- [ ] 
- [ ] 
...
| Tarea | Responsable | Estado | Fecha limite |
|-------|-------------|--------|--------------|
|       |             | ⬜ pendiente |              |
|       |             | ⬜ pendiente |              |
|       |             | ⬜ pendiente |              |
...
<!-- Arbol de archivos o modulos del proyecto (actualizar a medida que se avanza) -->
...
---
_Proyecto creado el 2026-03-17 con `plantilla_proyecto.md`_