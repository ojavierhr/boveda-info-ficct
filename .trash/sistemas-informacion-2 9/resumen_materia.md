...
FROM "01-materias/<% materia %>/clases"
...
FROM "01-materias/<% materia %>/proyectos"
WHERE tipo = "proyecto"
...
FROM "01-materias/<% materia %>/temas"
WHERE tipo = "tema"
SORT file.name ASC
```
...
FROM "01-materias/<% materia %>/recursos"
SORT file.name ASC
```
