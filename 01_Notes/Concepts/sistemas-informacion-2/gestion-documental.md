...
La gestión documental es un sistema para **organizar y controlar documentos electrónicos** de forma centralizada, eliminando el papeleo y facilitando el acceso rápido.
...
Back: Sistema para organizar y controlar documentos electrónicos de forma centralizada, incluyendo metadatos, versionado y flujos de trabajo.
...
START
Básico
¿Con qué concepto se suele confundir la gestión documental?
Back: Con el simple almacenamiento en carpetas (sin metadatos, sin búsqueda avanzada, sin flujos de trabajo ni seguridad).
