...
PROPÓSITO: No es un diario personal. Es una herramienta operativa para:
...
%%
Zona de captura libre. Todo lo que pase por tu cabeza:

- Ideas
- Dudas
- Cosas que te acordaste en clase
- Conceptos que no entendiste
- Tareas
- Links que querés revisar
- Etc
...
%%
El plugin Tasks muestra automáticamente todas las tareas con fecha de hoy. No editás nada acá: lo que aparece viene de tus notas de proyectos y clases.
%%
